...
```text
โจทย์ถามว่าอยากรู้ว่ามีร้านไหนเปิดบ้างเวลานี้
```
...
```text
อ่านโจทย์ให้ครบถ้วนว่าให้อะไรมาบ้างและกำหนดinput
```
...
```text
ใช้ตามแผนที่คิดไว้ หาจำนวนเต็ม2ค่า แต่ละบรรทัดมีstartและstop
```

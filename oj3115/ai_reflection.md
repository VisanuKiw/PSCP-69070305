...
| OJ submission ID, if submitted | 	612040 |
| OJ status | Pass |
...
```text
ช่วยการกำหนดแนวคิดและlogicทีละน้อย และมองให้เป็นระบบ
```
...
```text
สังดกตความต้องการที่แท้จริงของโจทย์
```
...
```text
แก้pep8 และแก้ไขการเว้นว่างหรือตัวแปรที่ไม่ได้ใช้
```
...
```text
เรียนรู้การตรวจทาน การคิดเป็นระบบ
```

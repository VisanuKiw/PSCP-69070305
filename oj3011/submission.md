...
```text
โจทย์กำหนดแม่สีหลักมาสามสี โดยที่ให้แต่ละสีเอามาผสมกัน แล้วถ้ามีสีอื่นที่ไม่ใช่สีหลักมาปนให้ขึ้นerror
inputคือสีสองสี
outputคือผลลัพธ์ของการผสมสี
constraintsการกำหนดว่าถ้าสองสีที่เหมือนกันมาผสมกันล่ะจะเป็นยังไง
```
...
```text
กำหนดค่าinputสามตัวที่เป็นสีหลัก แล้วเอามาprintออกมาเป็นสีหลังผสมกัน
```
...
```text
กำหนดสีหลักสามสีมาผสมกันแล้วออกมาเป็นoutputด้วยการใช้if elif else
```
...
```text
ถ้าไม่ใช่สีที่ถูกกำหนดจะerrorไหม
```
...
```text
ช่วยคิดว่าเราตกหล่นอะไรไปรึป่าว และวิเคราะห์testcaseไหน
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนelif ตรวจสอบความรอบคอบ และสัญลักษ์ และความเป็นไปได้ทั้งหมด
```

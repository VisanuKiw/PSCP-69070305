...
| OJ submission ID, if submitted | 612298 |
| OJ status | Pass |
...
```text
ช่วยบอกไพ่มีอะไรบ้างแล้วหน้าตาเป็นยังไง
```
...
```text
ช่วยสังเกตว่าโจทย์ต้องการอะไรและคอยใช่วยhintเล็กน้อย
```
...
```text
ตรวจสอบความถูกต้องของinput output
```
...
```text
เรียนรู้ไพ่ เรียนรู้การแบ่งแต้ม การคิดเป็นหรือตามโจทย์
```

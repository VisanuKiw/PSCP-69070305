...
| OJ submission ID, if submitted | 612240	
 |
| OJ status | Pass |
...
```text
ช่วยถามให้แน่ใจว่าโจทย์จะสื่อถึงอะไรเพราะโจทย์มันยาวและงงมาก
```
...
```text
ช่วยบอกหลักการหรือแนวคิดว่าจะสื่อถึงหรือต้องการอะไร
```

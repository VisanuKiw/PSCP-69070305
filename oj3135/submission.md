...
```text
มีคนnคนอยู่ในห้องโดยของขวัญจะถูกวนไปรวมถึงโจรจะได้ตรวจสอบด้วย
```
...
```text
รับinputเข้ามา3ตัวและกำหนดสมการตามที่โจทย์หรือเงื่อนไขกำหนด
```
...
```text
ใช้loopในการวนของขวัญไป และให้แสดงเป็นคนที่พิจารณาของขวัญ
```

...
```text
โจทย์ให้เริ่มต้นด้วยinput aจนไปถึงinput b แล้วdคือตัวหาร และrคือเศษ
```
...
```text
ดูสิ่งที่โจทย์ต้องการละวางแผนว่าเขาต้องการอะไรบ้าง แล้ววางแผนออกมาคล่าวๆ
```
...
```text
ทำตามแผนที่วางไว้โดยการกำหนดตัวแปรก่อน แล้วใช้loopให้aถึงb
```

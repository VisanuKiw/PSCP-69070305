...
| OJ submission ID, if submitted | 3031 |
| OJ status | Pass |
...
```text
ถามwhat if ว่าถ้าใส่เลขนี้ๆ ผลลอกมาจะเป็นยังไง และลองคำนวณว่าใช้อะไรดีระหว่างwhile กับfor _ in range
```
...
```text
สังเกตเห็นโค้ดที่ผิดหรือไม่จำเป็นต้องใส่ก็ได้ และแนะนำการเขียนและมีแนวคิดยังไงว่าเขียนให้สั้นที่สุดและกระชับ
```
...
```text
แก้ไขพวกการเว้นว่าง เพื่อความสะดวกในการอ่าน เช่น เว้นตรงสระ
```
...
```text
เรียนรู้จากการเขียนส่ามันยาวเกินไปและมีวิธีที่สั้นกว่าแต่ประสิทธิภาพดีขึ้น
```

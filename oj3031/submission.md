...
```text
โจทย์ให้หาว่าพื้นที่หมึกที่จะขยายต่อวินาทีและแสดงoutputเป็นว่าบ้านจะถูกท่วมเมื่อวินาทีใด
```
...
```text
ให้คิดสูตรในหัวก่อนแล้วลองเขียนไปโดยใช้คำสั่งimport mathและกำหนดค่าpi
```
...
```text
ใช้สูตรคณิตที่อยู่ในหัวคิดออกมาโดยการใช้loopหาระยะเวลาและตำแหน่ง
```

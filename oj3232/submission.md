...
```text
กบกระโดดไปข้างหน้าโดยแต่ละครั้งจะลดสอง ถ้าไปถึงจุดหมายจะโดดกี่ก้าว
```
...
```text
กำหนดจัวแปรโดยการรับค่าเข้ามา ละเอาไปคำนวณโดยใช้loop
```
...
```text
ต่อยอดจากแผนแรก เพราะloopแต่ละครั้งต้องลดระยะโดดลง
```

...
```text
โจทย์ให้เราตั้งเป้าหมายว่าระยะเท่าไหร่ แล้วให้ใช้อิฐก้อนใหญ่สุดก่อนเสมอ แล้วที่เหลือให้ใช้ก้อนเล็ก แล้วหาว่าใช้ก้อนเล็กกี่ก้อน
```
...
```text
ให้ตั้งgoalก่อน เสร็จแล้วก็หักระยะของก้อนใหญ่ ถ้าไม่ครบก็ไม่สามารถสร้างได้
```
...
```text
ทำตามแผนที่วางไว้คือการตั้งgoalก่อน แล้วใส่จำนวนของก้อนใหญ่และก้อนเล็ก แล้วให้คำนวณว่าหลังจากลบหมดแล้วใช้ก้อนเล็กกี่ก้อน
```

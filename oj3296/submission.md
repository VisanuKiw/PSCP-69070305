[submission.md](https://github.com/user-attachments/files/32613184/submission.md)
# บันทึกการแก้โจทย์
...
```text
คิดก่อนว่าโจทย์ต้องการอะไร ควรใช้ฟังชั่นไหน แล้วoutputต้องได้อะไร
```
...
```text
ใส่inputโดยการsplitเก็บไว้ในlist แล้วนำindexมาบวกกันละหาร2
```
...
```text
ทำตามแผนที่ได้มา พอลองrunแล้วมันมีทศนิยมเลยใช้mathมาช่วย
```

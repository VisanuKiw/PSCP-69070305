...
```text
โจทย์ให้เราหาราคาของอาหาร,เครื่องดื่มแล้วก็รวมกับค่าบริการซึ่งขั้นต่ำคือ50 แล้วมากสุดคือ1000
input:คือราคาที่ก่อนจะรวมกับค่าบริการแล้วก็vatอีก7%
output:คือราคาอาหาร,เครื่องดื่มที่รวมกับค่าบริการแล้วก็vatแล้ว
constraint:การคิดสมการออกมาในหัว เช่นถ้าอยากบวกกับvat7%ต้องใช้เลขอะไร
```
...
```text
กำหนดค่าinputก่อนแล้วกำหนดว่าราคาหลังจากบวกค่าบริการต้องใช้สูตรอะไร
```
...
```text
วิธีสุดท้ายคือกำหนดให้ค่าบริการขั้นต่ำ50บาท สูงสุด1000บาท แล้วก็เอาไปบวกกับราคาสินค้า แล้วก็เอาไปคูณvat7%
```
...
```text
เพราะทดสอบค่าบริการขั้นต่ำ50บาท
```
...
```text
เพราะทดสอบค่าบริการสูงสุด1000บาท
```
...
```text
เพราะค่าบริการสูงสุดและต่พสุดไม่เกินโจทย์กำหนด
```

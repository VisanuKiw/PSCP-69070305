...
```text
ให้หาว่าส่งของสถานที่ต้นทางไปยังปลายทางใช้ค่าใช้จ่ายเท่าไหร่
```
...
```text
กำหนดตัวแปร และกำหนดราคาเก็บไว้ในตัวแปร แล้วให้else if
```
...
```text
ทำตามแผนแรหที่วางแผนเอาไว้ และ คำนวณจากต้นทางไปปลายทาง และใช้น้ำหนักเข้ามาคิดด้วย
```

...
```text
ให้รับค่าinputแล้วแสดงออกมาว่ามีaeiouหรือไม่ ถ้ามีให้แสดงว่ามีกี่ตัว
```
...
```text
วางแผนโดยการlistก่อนว่าสระอะไรบ้างแล้วสั่งให้มันloop
```
...
```text
ทำตามแผนที่วางไว้โดยการloopมาเก็บไว้ในตัวแปร
```

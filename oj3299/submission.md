[submission.md](https://github.com/user-attachments/files/32614372/submission.md)
# บันทึกการแก้โจทย์
...
```text
อ่านinput output แล้วสิ่งที่โจทย์กำหนดดีๆ
```
...
```text
ตีความสิ้งที่โจทย์ต้องการจากรูปที่เขาให้มา แล้วเอามาใส่ในinputละตั้งสมการ
```
...
```text
กำหนดแผนแล้วทำตามนั้น ลองtestcaseหลายๆแบบ
```

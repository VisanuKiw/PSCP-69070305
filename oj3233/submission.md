...
```text
ถ้ารางวัลกับผลที่ออกตรงกันให้ได้รางวัล และเงินจะลดลงตามเลขที่ถูก
```
...
```text
กดหนดตัวแปรขึ้นมาสองตัวคือรางวัล กับของเรา แล้วค่อยๆcheckทีละตัว
```
...
```text
ใช้ตามแผนแรกด้วยelifไปเรื่อยๆโดยการเช็คเงื่อนไข
```

...
```text
โจทย์ให้หาว่าห้องที่เราอยู่นั้นสามารถไปยังห้อง1ได้โดยการใช้การทำลายกำแพงที่น้อยที่สุดยังไง
```
...
```text
เอาภาพในหัวออกมาเป็นสมการคณิตและใช้แผนifมาประยุกต์ใช้
```
...
```text
ใช้แบบเดียวกันกับที่คิดไว้เพราะสมการหรือแนวคิดมันค่อนค้างที่จะง่าย
```

...
```text
โจทย์ให้รับค่าinputเป็นอักษร5ตัวแล้วให้reverseคำ
inputคือการรับตัวอักษร5ตัว
outputคือตัวอักษรหลังถูกreverseแล้ว
constraintsคือการทำให้ตัวอักษรสลับกันจากหน้าไปหลัง
```
...
```text
กำหนดค่าinputก่อน แล้วหาวิธีทำให้reverseตัวอักษร
```
...
```text
รับค่าinputมาเก็บในตัวแปรแล้วทำให้reverseตัวแปรด้วยเครื่องหมายลบ
```
...
```text
ทดสอบตัวอักษรให้reverseแล้วพิมพ์เล็ก
```

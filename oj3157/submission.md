...
```text
ให้แสดงผลว่าถ้า+ - เท่านี้ๆ ผลสุดท้ายจะมีคะแนนเท่าไหร่
```
...
```text
กำหนดตัวแปร และใช้loopใส่inputจนครบ และprintออกมา
```
...
```text
ทำตามแผนที่วางไว้ กำหนดพวกสัญลักษณ์ แทนบวกเท่าไหร่ ลบเท่าไหร่
```

...
```text
โจทย์ให้รับค่าinputเป็นตัวเลขละเอาinputมาแสดงตัวเลขที่หารด้วย10ลงตัว
```
...
```text
รับค่าinputมาแล้วให้แสดงตัวเลขที่หารด้วย10ลง
```
...
```text
ใช้แผนเหมือนการวางแผนให้เอาตัวเลขที่เราแสดงมาหารด้วย10ละแสดงค่าแบบเว้นวรรค
```

...
```text
ให้กำหนดว่าถ้าเป็นสมาชิกให้ใช้ส่วนลด ถ้าไม่แต่ยอดรวมมากกว่าหรือเท่ากับ500ให้ลด3% ถ้ากรณีอื่นไม่ลด
```
...
```text
สร้างตัวแปรและจำนวนรายการที่ซื้อโดยการloop
```
...
```text
ทำตามแผนที่วางไว้และมีการใช้else ifเข้ามาด้วย และกำหนดส่วนลดโดยการใช้ทศนิยม
```

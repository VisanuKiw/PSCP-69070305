...
| OJ submission ID, if submitted | 611097 |
| OJ status | Pass |
...
```text
ช่วยกำหนดscopeให้เล็กลงเพราะตอนแรกคิดเยอะเกินไป ทั้งๆที่โจทย์มันสามารถเขียนให้สั้นได้
```
...
```text
สังเกตความผิดของlogicแล้วการตรวจสอบpep8
```
...
```text
logicผิด โค้ดยาวเกินความจำเป็น pep8
```

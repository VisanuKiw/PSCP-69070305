...
```text
กำหนดค่าอุณหภูมิค่านึงมาแล้วให้แปลงเป็นอีกค่า
```
...
```text
วางแผนโดยการใช้else if แล้วกำหนดว่าพิมพ์แบบนี้มาใช้สูตรแปลงไปอีกค่า
```
...
```text
ทำเหมือนแผนที่วางไว้โดยการกำหนดelse if แล้วแปลงค่าโดยใช้สูตรที่เขาให้มา
```

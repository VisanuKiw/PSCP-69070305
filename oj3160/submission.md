...
```text
ให้เริ่มต้นด้วยเลขที่เราใส่และจบด้วยเลขที่เราใส่ และให้หาว่าระหว่างนั้นมีตัวไหนบ้างที่เป็นจำนวนเฉพาะ
```
...
```text
กำหนดตัวแปร รับค่าเริ่มต้น ค่าจบ และให้หาว่ามีกี่ตัว
```
...
```text
ต่อยอดจากการวางแผน และprintออกมาว่ามีตัวอะไรบ้าง และผลสรุปสุดท้ายมีกี่ตัว
```
